...
## for DPS Testing
model_id = "dtmi:AIMobile:NC_N1;1"
...
def getGpuUsage():
    try:
        proc = subprocess.Popen('sudo tegrastats | head -n 1',shell=True,stdout=subprocess.PIPE)
        out,err =proc.communicate()
        out = out.decode()
    ...
    while True:
        if os_type == "Linux":
            if 'x86' in machine:
                ...
                currentTemp = psutil.sensors_temperatures()['thermal-fan-est'][0][1]
